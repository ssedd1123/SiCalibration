...
//   (at Tue Dec 12 21:11:22 2017 by ROOT version 6.04/02)
...
class Proxy_Interface {
   // This class defines the list of methods that are directly used by test,
...
class test : public TSelector, public Proxy_Interface {
public :
...
#ifdef __MAKECINT__
#pragma link C++ class test::TClaPx_TObject-;
#pragma link C++ class test::TClaPx_RBHINPHit-;
#pragma link C++ class test::TPx_TObject-;
#pragma link C++ class test::TPx_TNamed-;
#pragma link C++ class test::TPx_TNamed_1-;
#pragma link C++ class test::TPx_RBDetector-;
#pragma link C++ class test::TPx_RBHiRATelescope-;
...
inline void test::Init(TTree *tree)
{
...
inline void test::Begin(TTree *tree)
{
...
inline void test::SlaveBegin(TTree *tree)
{
...
inline Bool_t test::Process(Long64_t entry)
{
...
inline void test::SlaveTerminate()
{
